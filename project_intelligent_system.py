...
if page == "📘 ML Model":
     ...
     # โหลด model
     model = joblib.load(os.path.join(BASE_DIR, 'model_ml1.pkl'))
...
if page == "📗 Neural Network":
     ...
     try:
          nn_model = tf.keras.models.load_model(os.path.join(BASE_DIR, 'nn_model1.h5'))
          nn_scaler = joblib.load(os.path.join(BASE_DIR, 'scaler1_nn.pkl'))
     except:
